...
| **cc-intraday-monitor** | `*/5 8-16 * * 1-5` | shared | Barchart overview HTML (httpx, delayed ~10-12 min + CDN cache ≤300s) + `pl_derived_indicators` (S1/R1) + `ref_alert_rule` | `pl_contract_data_intraday` (append) + `aud_alert_event` + Telegram sendMessage | ✅ Actif (LIVE telegram) |
