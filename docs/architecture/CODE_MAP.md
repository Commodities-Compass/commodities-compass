...
- **Writes**: `pl_origin_declaration`, `pl_origin_purchase`, `pl_origin_grinding`, `pl_origin_entity`, `pl_origin_flow_monthly` (the cube), `pl_origin_ingest_batch` (audit trail). Migration `n9c0d1e2f3g4`.
...
- **Docs**: [watchai-ingestion.md](../runbooks/watchai-ingestion.md) (incl. the prod-load procedure) · [business-rules.md](../feature-proposals/watchai/business-rules.md) · [watchai-integration.md](../feature-proposals/watchai/watchai-integration.md) · memory `project_watchai_origin_ingestion`.
