...
const strings = {
  fr: {
    ...
    brief: {
      ...
      briefBanner: 'Exemple éditorial · données illustratives, non opérationnelles',
      ...
      briefMetaConviction: 'Conviction nette : forte',
      briefMetaHorizon: 'Horizon : ~4 J',
      briefMetaFormat: 'FR natif · 4 min lecture',
  ...
  en: {
    ...
    brief: {
      ...
      briefBanner: 'Editorial sample · illustrative data, not operational',
      ...
      briefMetaConviction: 'Net conviction: strong',
      briefMetaHorizon: 'Horizon: ~4 d',
      briefMetaFormat: 'Native EN · 4 min read',
