...
const strings = {
  fr: {
    ...
    bento: {
      sectionRoman: 'II',
      sectionTitle: 'Ce que vous lisez chaque matin',
    ...
    contact: {
      sectionEyebrow: 'V · Demander un accès',
    ...
    footer: {
      ...
      colReadHeading: 'Lecture',
      colRead1: 'Ce que vous lisez',
      colRead2: 'Méthodologie',
      colRead3: 'Distribution',
      colContactHeading: 'Contact',
      colContact1: 'Demander un accès',
      colContact2: 'Email',
  ...
  en: {
    ...
    bento: {
      sectionRoman: 'II',
      sectionTitle: 'What you read each morning',
    ...
    contact: {
      sectionEyebrow: 'V · Request access',
    ...
    footer: {
      ...
      colReadHeading: 'Reading',
      colRead1: 'What you read',
      colRead2: 'Methodology',
      colRead3: 'Distribution',
      colContactHeading: 'Contact',
      colContact1: 'Request access',
      colContact2: 'Email',
      colContact3: 'LinkedIn',
